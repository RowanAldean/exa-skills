...
| Command | Description |
|---------|-------------|
| `/exa:events` | Find events, hackathons, and event organizers using targeted domain and people searches |
...
| Skill | Useful for |
|-------|------------|
| `exa-events` | Discovering events, meetups, hackathons, and their organizers via targeted platforms (Luma, Devpost) |
